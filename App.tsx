...
import { POR_PARA_QUESTIONS, TENER_QUESTIONS, HAY_QUESTIONS, Question } from './constants';

type GameType = 'menu' | 'por_para' | 'tener' | 'hay';
          ...
          >
            <div className="text-center space-y-4">
               ...
               <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter uppercase text-slate-900">
                 ԻՍՊԱՆԵՐԵՆԻ <span className="text-sky-600">ԱՇԽԱՐՀ</span>
               </h1>
               <p className="text-slate-400 font-bold uppercase tracking-[0.4em] text-xs md:text-sm">
                 SPANISH LEARNING ADVENTURE • 3 GAMES
               </p>
            </div>
